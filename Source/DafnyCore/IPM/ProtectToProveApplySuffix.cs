...
namespace DafnyCore.IPM {
  public class ProtectToProveApplySuffix : ApplySuffix, ICloneable<ProtectToProveApplySuffix> {
    ...
    [SyntaxConstructor]
    public ProtectToProveApplySuffix(Expression e) : base(e.Origin, null, new NameSegment(SourceOrigin.NoToken, ProtectToProveFunction.ProtectorFunctionName, null), [
